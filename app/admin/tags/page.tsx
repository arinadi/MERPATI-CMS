...
export default async function TagsPage({
    ...
    const { terms, error } = await getTerms("tag");

    if (error || !terms) {
        return <div className="p-8 text-destructive">{error || "Failed to load tags"}</div>;
    }
        ...
        <div className="p-8 max-w-6xl mx-auto space-y-8">
            <div>
                ...
                <p className="text-muted-foreground mt-2">
                    Manage flat post categorization and keywords.
                </p>
            </div>
